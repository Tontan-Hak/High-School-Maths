...
* [x] [ជំពូកទី ០១ \. តក្កវិទ្យា សំណុំនិងចំនួន](#មេរៀនទី-១-តក្កវិទ្យា)
    * [មេរៀនទី ១ \. តក្កវិទ្យា](#មេរៀនទី-១-តក្កវិទ្យា)
...
* [x] [ជំពូកទី ០២ \. ពហុធា](#ជំពូកទី-០២-ពហុធា) 
    ...
    * [មេរៀនទី ២\. ប្រមាណវិធីចែកពហុធា](#មេរៀនទី២-ប្រមាណវិធីចែកពហុធា)
* [x] [ជំពូកទី ០៣ \. សមីការនិងវិសមីការ](#ជំពូកទី-០៣-សមីការនិងវិសមីការ) 
    * [មេរៀនទី ១\. សមីការដឺក្រេទី២មាន​មួយអញ្ញាត](#មេរៀនទី១-សមីការដឺក្រេទី២មាន​មួយអញ្ញាត)
    * [មេរៀនទី ២\. ប្រព័ន្ធសមីការនិងសមីការដឺក្រេខ្ពស់](#មេរៀនទី២-ប្រព័ន្ធសមីការនិងសមីការដឺក្រេខ្ពស់)
    * [មេរៀនទី ៣\. វិសមីការ](#មេរៀនទី៣-វិសមីការ)
* [x] [ជំពូកទី ០៤ \. ធរណីមាត្រក្នុងប្លង់](#ជំពូកទី-០៤-ធរណីមាត្រក្នុងប្លង់) 
    * [មេរៀនទី ១\. កូរអរដោនេនៃចំណុច](#មេរៀនទី១-កូរអដោនេនៃចំណុចនៅលើប្លង់)
...
# ជំពូកទី ០១​ តក្កវិទ្យា សំណុំនិងចំនួន
> ខាងក្រោមនេះជា វីដេអូភាសាអង់គ្លេស សម្រាប់ Engage កូនសិស្ស ដោយប្រាប់ពីហេតុផល ដើមចម ថាតើ ហេតុអ្វីបានជាអ្នកប្រាជ្ញមានគំនិតទាក់ទងនឹង ទ្រឹស្តី គោលការណ៍ ក្នុងជំពូកនេះ? ពួកគាត់គិតយ៉ាងម៉េចបានចេញរូបមន្តហ្នឹងមក? <br>
...
## មេរៀនទី២ ប្រព័ន្ធសមីការនិងសមីការដឺក្រេខ្ពស់
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
	...
	* [📚 ឯកសាររៀបរាងដោយលោក លឹម ផល្គុន​​](https://drive.google.com/file/d/1vJF3wkdhIZDEacGcwtE4HBUoN6zjs8Co/view?usp=sharing)
##
<div align="right">
...
**Topics Covered:** `1.ក្រាបនៃអនុគមន៍`$\{y=ax^2}$ `2.ក្រាបនៃអនុគមន៍`$y=a(x-p)^2$ `3.ក្រាបនៃអនុគមន៍`$y=a(x-p)2+q$ `4.តម្លៃអតិបរមា និង​អប្បបរមា នៃអនុគមន៍ដឺក្រេទី២` `5.ដំណោះស្រាយសមីការ និងវិ.ដឺក្រេទី២តាមក្រាប` `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
...
**Topics Covered:** `1.អនុគមន៍សនិទាន និងក្រាប` `2.អនុគមន៍អសនិទានងាយ និងក្រាប` `3.ក្រាបអនុគមន៍ច្រាស` `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
...
## មេរៀនទី១ ផលធៀបត្រីកោណមាត្រ
**Topics Covered:** `1.តង់សង់` `2.ស៊ីនុស និងកូស៊ីនុស` `3.តម្លៃផលធៀបត្រីកោណមាត្រ` `4.ទំនាក់ទំនងផលធៀបត្រីកោណមាត្រ` `5.ការពន្លាតនៃផលធៀបត្រីកោណមាត្រ` `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
	* [📚 ដំណោះស្រាយលំហាត់](https://drive.google.com/file/d/1s6hBbXhNTpQFz7WdaFZEzKXnWeBiHETj/view?usp=sharing)
	* [📚 ឯកសាររៀបររៀងដោយគរុនិសិ្សតជំនន់ទី១៥](https://drive.google.com/file/d/0B1dv5sqSPsPbem9tQXVqUC12aWs/view?usp=sharing&resourcekey=0-J-NdFSq17DFeOM8HTX7nPw)
##
<div align="right">
...
## មេរៀនទ២ អនុវត្តន៍ត្រីកោណមាត្រ
**Topics Covered:** `1.ទ្រឹស្តីបទស៊ីនុស` `2.ទ្រឹស្តីបទកូស៊ីនុស` `3.ផ្ទៃក្រឡានៃត្រីកោណ` `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
	* [🎬 ការអនុវត្តផលធៀបត្រីកោណមាត្រ(ភាគ១)](https://www.youtube.com/watch?v=SrSCh4DlQY8)
...
## មេរៀនទី១ បំណែងចែកប្រេកង់
**Topics Covered:** `1.អថេរបរិមាណនិងអថេរគុណភាព` `2.បំណែងចែកប្រេកង់នៃទិន្នន័យមិនផ្តុំជាថ្នាក់និងការតាងក្រាប` `3.បំណែងចែកប្រេកង់នៃទិន្នន័យផ្តុំជាថ្នាក់និងការតាងក្រាប` `4.បំណែងចែកប្រេកង់កើននិងប្រេងកង់ថយ
` `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
	* [🎬 ១.អថេរបរិមាណ និងអថេរគុណភាព](https://www.youtube.com/watch?v=GV-lH7r8bSk)
...
## មេរៀនទ២ រង្វាស់ទីតាំង
**Topics Covered:** `1.មធ្យម `2.មេដ្យាន` `3.ម៉ូត `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
...
## មេរៀនទី១ ចម្លាស់
**Topics Covered:** `1.គោលការណ៍របាប់` `2.ចម្លាស់` `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
	* [🎬 គោលការណ៍របាប់](https://www.youtube.com/watch?v=bi_BtSijBLk)
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
	* [📚 ឯកសាររៀបររៀងដោយគរុនិសិ្សតជំនន់ទី១៥](https://drive.google.com/file/d/0B1dv5sqSPsPbcXhud1FFVGVsUkE/view?usp=sharing&resourcekey=0-4QOkRsx5qOuCP2ZooKQ-aQ)
...
## មេរៀនទី១ វុិចទ័រនិងប្រមាណវិធីលើវុិចទ័រ
**Topics Covered:** `1.និយមន័យ` `2.ប្រមាណវិធីបូក និង​ដកវ៉ិចទ័រ` `3.ប្រមាណវិធីគុណវ៉ិចទ័រ និងចំនួនពិត` `4.កូអរដោនេនៃវ៉ិចទ័រក្នុងប្លង់` `5.ផលគុណស្កាលែ` `ធ្វើលំហាត់` <br>
**Prerequisites:** `ប្រភាគ` `ការធ្វើប្រមាណវិធី` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `ពន្លាតកន្សោម`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន៖
	* [🎬 វ៉ិចទ័រ និងប្រមាណវិធីលើវ៉ិចទ័រ​(ភាគ១)](https://www.youtube.com/watch?v=bDrwtjycWwo)
	* [🎬 វ៉ិចទ័រ និងប្រមាណវិធីលើវ៉ិចទ័រ​(ភាគ២)](https://www.youtube.com/watch?v=3w7MU7eI3Rg)
	* [🎬 វ៉ិចទ័រ និងប្រមាណវិធីលើវ៉ិចទ័រ​(ភាគ៣)](https://www.youtube.com/watch?v=lSAS1dWLFQE&t=1s)
	* [🎬 ​វ៉ិចទ័រ និងប្រមាណវិធីលើវ៉ិចទ័រ​(ភាគ៤)](https://www.youtube.com/watch?v=Tu6XunhRx9c&t=1s)
	* [🎬 ​វ៉ិចទ័រ និងប្រមាណវិធីលើវ៉ិចទ័រ​(ភាគ៥)](https://www.youtube.com/watch?v=e0hPxWRQwwI&t=2s)
	* [🎬 ​វ៉ិចទ័រ និងប្រមាណវិធីលើវ៉ិចទ័រ​(ភាគបញ្ចប់)](https://www.youtube.com/watch?v=zz6d3HxdRu8)
	* [🎬 វ៉ិចទ័រនិងប្រមាណវីធីវ៉ិចទ័រ (Video playlist)](https://www.youtube.com/playlist?list=PLHIDhoWPChfXQa5yYgKrt-NH4UQYOmpzt)
