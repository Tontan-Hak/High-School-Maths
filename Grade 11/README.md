...
**Topics Covered:** `1.កំណត់តួទីn ដោយប្រើស្វីតជំនួយ` `2.ទំនាក់ទំនងរវាង` $\a_n$ `និង` $\s_n$` `3.ទំនាក់ទំនងកំណើនក្នុងទម្រង់`$\a_(n+2)$`សម្រាប់ផលបូកនៃស្វីត` `4.របៀបកំណត់តួទីnតាមផលសងរួមនៃស្វីត` `អនុវត្តន៍លំហាត់` <br>
**Prerequisites:** `Basic algebra` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `អនុគមន៍` `អនុគមន៍ត្រីកោណមាត្រ`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន ៖
