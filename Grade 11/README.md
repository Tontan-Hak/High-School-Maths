...
* [x] [ជំពូកទី ០២ \. ស្វីតនិងអនុមានរួមគណិតវិទ្យា](#ជំពូកទី-០២-ស្វីតនិងអនុមានរួមគណិតវិទ្យា) 
    * [មេរៀនទី ១\. ផលបូកតួនៃស្វីតផ្សេងៗ](#មេរៀនទី១-ផលបូកតួនៃស្វីតផ្សេងៗ)
    * [មេរៀនទី ២\. ទំនាក់ទំនងតួនៃស្វីត](#មេរៀនទី២-ទំនាក់ទំនងតួនៃស៊ី្វត)
    * [មេរៀនទី ៣\. វិចារអនុមានរួមគណិតវិទ្យា](#មេរៀនទី៣-វិចារអនុមានរួមគណិតវិទ្យា) 
* [x] [ជំពូកទី ០៣ \. អនុគមន៏អ៊ិចស្យ៉ូណង់ស្យែល និងអនុគមន៏លោការីត](#ជំពូកទី-០៣-អនុគមន៏អ៊ិចស្យ៉ូណង់ស្យែល-និងអនុគមន៏លោការីត) 
    * [មេរៀនទី ១\. អនុគមន៏អ៊ិចស្យ៉ូណង់ស្យែល](#មេរៀនទី១-អនុគមន៏អ៊ិចស្យ៉ូណង់ស្យែល)
    * [មេរៀនទី ២\. អនុគមន៏លោការីត](#មេរៀនទី២-អនុគមន៏លោការីត)
* [x] [ជំពូកទី ០៤ \. អនុគមន៏ត្រីកោណមាត្រ](#ជំពូកទី-០៤-អនុគមន៏ត្រីកោណមាត្) 
    * [មេរៀនទី ១\. អនុគមន៏ត្រីកោណមាត្រ](#មេរៀនទី០១-អនុគមន៏ត្រីកោណមាត្រ)
    * [មេរៀនទី ២\. រូបមន្តត្រីកោណមាត្រ](#មេរៀនទី០២-រូបមន្តអនុគមន៍ត្រីកោណមាត្រ)
    * [មេរៀនទី ៣\. សមីការនិងវិសមីការត្រីកោណមាត្រ](#មេរៀនទី០៣-សមីការនិងវិសមីការអនុគមន៍ត្រីកោណមាត្រ)
* [x] [ជំពូកទី ០៥ \. ម៉ាទ្រីសនិងដេទែមីណង់](#ជំពូកទី-០៥-ម៉ាទ្រីសនិងដេទែមីណង់) 
    * [មេរៀនទី ១\. ម៉ាទ្រីស](#មេរៀនទី១-ម៉ាទ្រីស)
    * [មេរៀនទី ២\. ដេទែមីណង់](#មេរៀនទី២-ដេទែមីណង់)
* [x] [ជំពូកទី ០៦\. លីមីតនិងដេរីវេ](#ជំពូកទី-០៦-លីមីតនិងដេរីវេ)
    * [មេរៀនទី ១\. លីមីតនិងដេរីវេ](#មេរៀនទី០១-លីមីតនិងដេរីវេ)
    * [មេរៀនទី ២\. អនុវត្តន៏ដេរីវេ](#មេរៀនទី០២-អនុវត្តន៍ដេរីវេ)
    * [មេរៀនទី ៣\. អថេរភាននិងក្រាបនៃអនុគមន៍](#មេរៀនទី០៣-អថេរភាព-និងក្រាបនៃអនុគមន៍)
* [x] [ជំពូកទី ០៧\. ប្រូបាប](#ជំពូកទី-០៧-ប្រូបាប)
    * [មេរៀនទី ១\. ចម្លាស់](#ជំពូកទី-០៧-ប្រូបាប)
    * [មេរៀនទី ២\. បន្សំ](#ជំពូកទី-០៧-ប្រូបាប)
    * [មេរៀនទី ៣\. ប្រូបាប](#ជំពូកទី-០៧-ប្រូបាប)
* [x] [ជំពូកទី ០៨ \. ចំនួនកុំផ្លិច](#ជំពូកទី-០៨-ចំនួនកុំផ្លិច) 
    * [មេរៀនទី ១\. ចំនួនកុំផ្លិចទម្រង់ពិជគណិត](#ជំពូកទី-០៨-ចំនួនកុំផ្លិច)
    * [មេរៀនទី ២\. ចំនួនកុំផ្លិចទម្រង់ត្រីកោណមាត្រ](#ជំពូកទី-០៨-ចំនួនកុំផ្លិច)
    * [មេរៀនទី ៣\. ស្វ័យគុណទីn និងឬសទីn នៃចំនួនកុំផ្លិច](#ជំពូកទី-០៨-ចំនួនកុំផ្លិច)
    * [មេរៀនទី ៤\. អនុវត្តន៍ចំនួនកុំផ្លិចក្នុងធរណីមាត្រ](#ជំពូកទី-០៨-ចំនួនកុំផ្លិច)
* [x] [ជំពូកទី ០៩ \. វ៉ិចទ័រក្នុងលំហ](#ជំពូកទី-០៩-វ៉ិចទ័រក្នុងលំហ) 
    * [មេរៀនទី ១\. វ៉ិចទ័រក្នុងលំហ](#មេរៀនទី១-វ៉ិចទ័រក្នុងលំហ)
    * [មេរៀនទី ២\. សមីការបន្ទាត់ និងសមីការប្លង់ក្នុងលំហ](#)
* [x] [ជំពូកទី ១០ \. ស្ថិតិ](#ជំពូកទី-១០-ស្ថិតិ) 
    * [មេរៀនទី ១\. ការបែងចែកទិន្នន័យជាភាគរយ](#មេរៀនទី១-ការបែងចែកទិន្នន័យជាភាគរយ)
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
    * [📚 ឯកសាររៀបររៀងរៀងដោយៈអ៊ុង ពៅ](https://drive.google.com/file/d/1rit1cuY9UlMYHu6ik0Kirel29xAhbeUR/view?usp=sharing)
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
    * [📚 ឯកសាររៀបររៀងរៀងដោយ សុខ ពិសិដ្ឋ](https://drive.google.com/file/d/1p2rLDwQulVgOenL00gbUqiruqtkcp0fK/view?usp=sharing)
    * [📚 ឯកសាររបស់លោកគ្រូ-លឹម-ផល្គុន](https://drive.google.com/file/d/0B1dv5sqSPsPbaXpiU2JhVzBPZXM/view?usp=sharing&resourcekey=0-WjPtwG2-mqr4_R1aspn8Vg)
##
<div align="right">
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
    * [📚 ឯកសាររៀបររៀងរៀងដោយៈ ប.ផ](https://drive.google.com/file/d/1G6bwa1ZCu2hN1kyO3YtTQJUnkIqkn5ro/view?usp=sharing)
    * [📚 ឯកសាររបស់លោកគ្រូ អ៊ូច ប៊ុនផន](https://drive.google.com/file/d/1_-M4j79lCmOWom_q7rRiGGc4nXeNNQnA/view?usp=sharing)
##
<div align="right">
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
    * [📚 ឯកសាររៀបររៀងរៀងដោយៈ H.P](https://drive.google.com/file/d/1QD6oFtTTNu7TMYU7K8eiveJmDu_UNR0L/view?usp=sharing)
...
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
    * [📚 ឯកសាររៀបររៀងរៀងដោយៈ សន ពៅ (NIE)](https://drive.google.com/file/d/1qPJc3ZOT4hdDNn27XYeuPVcIWH1E0WxF/view?usp=sharing)
    * [📚 ឯកសាររបស់គរុនិស្សតិគណិតវិទ្យាក្រុមទី៣ជំនាន់ទី24 (NIE)](https://drive.google.com/file/d/16vEq93Gwyf0WPivwjacWzXrInAkqAnwS/view?usp=sharing)
##
<div align="right">
...
**Topics Covered:** `1.វ៉ិចទ័រក្នុងលំហ` `2.ប្រមាណវិធីនៃវ៉ិចទ៏រក្នុងលំហ` `3.កូអរដោនេនៃវ៉ិចទ៏រក្នុងលំហ` `4.ផលគុណស្គាលែនៃវ៉ិចទ័រក្នុងលំហ` `5.ផលគុណស្គាលែនិងការតាងកូអរដោនេ` `អនុវត្តន៍លំហាត់` <br>
**Prerequisites:** `Basic algebra` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `អនុគមន៍` `អនុគមន៍ត្រីកោណមាត្រ`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន ៖
    * [🎬 វ៉ិចទ័រក្នុងលំហ (ភាគ១)](https://www.youtube.com/watch?v=PHAMGwcCLgI&list=PLHIDhoWPChfV2So0msQjM2yZm6sFrp3B2)
    * [🎬 វ៉ិចទ័រក្នុងលំហ (ភាគ២)](https://www.youtube.com/watch?v=YwNiSagcsDY&list=PLHIDhoWPChfV2So0msQjM2yZm6sFrp3B2&index=2)
    
- មេរៀនសង្ខេប និង លំហាត់អនុវត្តន៍
    * [📚 ឯកសាររៀបររៀងរៀងដោយៈគរុនិស្សតិគណិតវិទ្យាក្រុមទី២ជំនាន់ទី24 (NIE)](https://drive.google.com/file/d/1EeOOCorFyXUc-ri4N9cBmySxvFOz2UaA/view?usp=sharing)
    * [📚 ឯកសាររបស់លោកគ្រូ-លឹម-ផល្គុន](https://drive.google.com/file/d/12WdgaENCZL6OsC6pJXNfd4quktfxGwJE/view?usp=sharing)
##
<div align="right">
...
**Topics Covered:** `1.រង្វាស់ទីតាំង` `2.រង្វាស់ទីតាំងនែទិន្នន័យផ្គុំជាប្រេកង់` `3.រង្វាស់ទីតាំងនៃទិន្នន័យផ្គុំជាថ្នាក់` `អនុវត្តន៍លំហាត់` <br>
**Prerequisites:** `Basic algebra` `ពហុធា` `កន្សោមពិជគណិត` `រូបមន្តសមភាពសំខាន់ៗ` `អនុគមន៍` `អនុគមន៍ត្រីកោណមាត្រ`
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន ៖
    * [🎬 ការបែងចែកទិន្នន័យជាភាគរយ (ភាគ១)](https://www.youtube.com/watch?v=qWoJn0OTe7w)
    * [🎬 ការបែងចែកទិន្នន័យជាភាគរយ (ភាគ២)](https://www.youtube.com/watch?v=rpYDV4xTF0Q&t=16s)
